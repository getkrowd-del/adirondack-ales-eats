async function loadEvents() {
  try {
    ...
    if (!events.length) { 
      container.innerHTML = '<p style="color:var(--text);grid-column:1/-1">No upcoming events — check back soon!</p>'; 
      return; 
    }
    ...
    document.getElementById('eventsContainer').innerHTML = '<p style="color:var(--text)">Could not load events. Call <a href="tel:+13155993366" style="color:var(--amber)">(315) 599-3366</a>!</p>'; 
  }
}
